...
def Init_Singal(self: "MyMAinWindow"):
    ...
    self.Ui.pushButton_check_fc2cmadb_cookie.clicked.connect(self.pushButton_check_fc2cmadb_cookie_clicked)
    ...
    self.set_fc2cmadb_status.connect(self.Ui.label_fc2cmadb_cookie_result.setText)
