...
def Init_Singal(self: "MyMAinWindow"):
    ...
    self.Ui.pushButton_fc2cmadb_login.clicked.connect(self.pushButton_fc2cmadb_login_clicked)
    ...
    self.set_fc2ppvdb_cookie.connect(self.Ui.plainTextEdit_cookie_fc2ppvdb.setPlainText)
