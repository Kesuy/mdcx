...
def test_network_check_button_keeps_shared_rounded_style(monkeypatch: pytest.MonkeyPatch):
    ...
    window = SimpleNamespace(
        ...
        network_check=lambda: None,
        network_check_cancel_event=None,
        t_net=None,
    )
    ...
    window.network_check_cancel_event = cancel_event
    MyMAinWindow.pushButton_check_net_clicked(window)
